...
class HRVMeasurement(Base):
    ...
    __table_args__ = (UniqueConstraint("measurement_date", "source_name", name="uq_measurement_date_source"),)
...
class HRVAnomaly(Base):
    ...
    detector: Mapped[str] = mapped_column(String(50), default="zscore")
